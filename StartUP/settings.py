...
SECRET_KEY = 'django-insecure-5+sj2cykx#su7_1g%(2*&hlex#&je0-1h_bhndbmttmy@7&fdj'
...
TEMPLATES = [
    {
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                'playground.context_processors.subs_prices',
            ],
        },
    },
]
...
STRIPE_PRICE_ID_SILVER = 'price_1KDWazCYYBi69bQMtMzT1HW5'
STRIPE_PRICE_ID_BRONZE = 'price_1KDWZNCYYBi69bQMfekvTLZS'
